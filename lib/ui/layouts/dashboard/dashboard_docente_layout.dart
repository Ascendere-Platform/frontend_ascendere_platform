...
import 'package:frontend_ascendere_platform/ui/shared/siderbat_docente.dart';
import 'package:frontend_ascendere_platform/ui/shared/widgets/options_avatar.dart';

class DashboardDocenteLayout extends StatefulWidget {
  const DashboardDocenteLayout({Key? key, required this.child})
      : super(key: key);

  final Widget child;

  @override
  State<DashboardDocenteLayout> createState() => _DashboardDocenteLayoutState();
}

class _DashboardDocenteLayoutState extends State<DashboardDocenteLayout>
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            Row(
              children: [
                if (size.width >= 700) const SidebarDocente(),
                Expanded(
                  child: Column(
