...
class CreateConvocatoriaView extends StatefulWidget {
  const CreateConvocatoriaView({Key? key}) : super(key: key);

  @override
  State<CreateConvocatoriaView> createState() => _CreateConvocatoriaViewState();
}

class _CreateConvocatoriaViewState extends State<CreateConvocatoriaView> {
